...
registro_error "make INSTALL_HDR_PATH=dest headers_install"

find dest/include \( -name .install -o -name ..install.cmd \) -delete
registro_error "find dest/include \( -name .install -o -name ..install.cmd \) -delete"

cp -rv dest/include/* /usr/include
registro_error "cp -rv dest/include/* /usr/include"
