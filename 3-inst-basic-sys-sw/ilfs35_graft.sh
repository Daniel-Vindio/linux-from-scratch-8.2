...
# This patch is to configure PACKAGEDIR and TARGETDIR
# Also to make possible automation (removing a @false that otherwise 
# would make the building to stop)
 
cp -v Makefile.dist{,.orig}
chmod -v 664 Makefile.dist
patch -N -i ../graft-$1.patch
registro_error "Parche ok"
...
ln -sv /usr/pkgs/graft-$1/bin/graft /usr/bin
registro_error "ln -sv /usr/pkgs/graft-$1/bin/graft /usr/bin"
